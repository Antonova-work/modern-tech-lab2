...
public class OrderAnalytics {
    ...
    public static void main(String[] args) {
        ...
        double grandTotal = orders.stream()
                ...
                .sum();
        System.out.println(grandTotal + " руб.");
        // ▲ КОНЕЦ ВАШЕГО КОДА ▲
        ...
        orders.stream()
                ...
                .forEach(o -> System.out.printf("%s: %.2f руб.%n", o.product(), o.total()));
        // ▲ КОНЕЦ ВАШЕГО КОДА ▲
        ...
        // ▼ ВАШ КОД ЗДЕСЬ ▼
        orders.stream()
                .max(Comparator.comparingDouble(Order::price))
                .ifPresent(o -> System.out.println(o.product() + " (" + o.price() + " руб.)"));
        // ▲ КОНЕЦ ВАШЕГО КОДА ▲
        ...
        // ▼ ВАШ КОД ЗДЕСЬ ▼
        Map<String, Double> avgByClient = orders.stream()
        ...
        System.out.println("Дорогие (>3000): " + partitioned.get(true).size());
        ...
        // ▼ ВАШ КОД ЗДЕСЬ ▼
        String premiumProducts = orders.stream()
