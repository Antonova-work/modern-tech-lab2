...
Строка | Компилируется? | Почему?
    -------|----------------|--------------------------------------------------
    A      | Да             | public — доступен из любого пакета.
    B      | Нет            | protected — виден только в пакете core и наследникам.
    C      | Нет            | default (без мод.) — виден только внутри пакета core.
    D      | Нет            | private — виден только внутри класса Employee.
    E      | Да             | public метод — доступен везде.
    F      | Нет            | protected метод — запрещен доступ из другого пакета.
    G      | Нет            | default метод — не виден за пределами своего пакета.
    H      | Нет            | private метод — скрыт ото всех, кроме самого класса.
    */
